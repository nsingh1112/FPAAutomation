...
def open_views(context):
    ...
    element = driver.find_element_by_accessibility_id('Controls')
    element.click()

@then('I verify checkbox and radio buttons')
def verify_check_box(context):
   element = driver.find_element_by_accessibility_id('1. Light Theme')
   element.click()
   check_box = driver.find_element_by_accessibility_id('Checkbox 1')
   check_box.click()
