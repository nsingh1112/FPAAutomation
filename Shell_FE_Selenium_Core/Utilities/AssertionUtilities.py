class AssertionUtilities:
    ...
    def assert_contains(valuetobesearched_for, valuetobesearched_in):
        ...
        assert valuetobesearched_for in valuetobesearched_in, "{0} is not present in {1}".format(valuetobesearched_for, valuetobesearched_in)
    ...
    def assert_not_contains(valuetobesearched_for, valuetobesearched_in):
        ...
        if valuetobesearched_in is None:
            assert False, "{0} is None or empty".format(valuetobesearched_in)
        assert valuetobesearched_for not in valuetobesearched_in, "{0} is present in {1}".format(valuetobesearched_for, valuetobesearched_in)
